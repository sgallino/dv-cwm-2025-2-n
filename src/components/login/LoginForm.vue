...
// Inyectamos en este componente la dependencia provista por App (que es un padre) usando la función inject().
...
function useLoginForm(router) {
    ...
    async function handleSubmit() {
        try {
            // Si ya estamos procesando la petición, no hacemos nada.
            ...
            feedback.value = {
                // TODO: Contemplar otros errores para otros mensajes.
